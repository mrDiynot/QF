    ...
    <div className="animate-fade-in">
      ...
      /*
        ...
        <BentoGrid>
          ...
          <BentoCard colSpan={2} rowSpan={2}>
            <BentoCardHeader
              icon={<Brain className="size-5 text-orange-400" />}
              title="AI Insights"
              subtitle="Powered by AI analysis"
            />
            <AIInsightsWidget maxInsights={3} showTrends={false} />
          </BentoCard>

        
          {/* Row 3: Channel Activity (2 cols) + AI Performance (2 cols) */}
          <BentoCard colSpan={2}>
            <BentoCardHeader
              icon={<Radio className="size-5 text-purple-400" />}
          ...
          <BentoCard colSpan={2}>
            <BentoCardHeader
              icon={<Brain className="size-5 text-purple-400" />}
