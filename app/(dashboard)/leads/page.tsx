...
import {
  ...
  MoreVertical, Eye, Edit, Trash2, Download, Upload, UserCheck, Bot
} from 'lucide-react';
    ...
    <div className="p-8">
      ...
      <div className="grid lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-xs border border-gray-200 p-6">
          ...
          <button className="mt-4 w-full px-4 py-2 bg-gradient-to-r from-orange-500 to-pink-600 text-white rounded-lg hover:shadow-lg transition-all flex items-center justify-center gap-2 text-sm font-medium">
        ...
        <div className="lg:col-span-3 bg-white rounded-xl shadow-xs border border-gray-200">
          ...
          <div className="p-6 border-b border-gray-200 relative">
            <div className="flex items-center justify-between mb-4">
              ...
              <button className="px-4 py-2 bg-gradient-to-r from-orange-500 to-pink-600 text-white rounded-lg hover:shadow-lg transition-all flex items-center gap-2 text-sm font-medium">
                <Plus className="w-4 h-4" />
                Add Contact
              </button>
            </div>
          ...
          <div className="p-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-2">
                        <div className="font-medium text-blue-950">{contact.name}</div>
                        ...
                        <div className="text-sm text-gray-600">
                          Score: <span className="font-medium text-blue-950">{contact.score}</span>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-2 mt-3">
                        <div className="flex items-center gap-2">
                          {contact.assignedBy === 'AI' ? (
                            <div className="flex items-center gap-1 px-2 py-1 bg-indigo-100 text-indigo-700 rounded text-xs font-medium">
                              <Bot className="w-3 h-3" />
                              <span>AI Assigned</span>
                            </div>
                          ) : (
                            <div className="flex items-center gap-1 px-2 py-1 bg-teal-100 text-teal-700 rounded text-xs font-medium">
                  ...
                  {selectedContact === index && (
                    ...
                    >
                          ...
                          <div className="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                              <div className="p-3 bg-blue-50 rounded-lg">
                                <div className="text-2xl font-semibold text-blue-950 mb-1">24</div>
                                <div className="text-xs text-gray-600">🤖 AI Contacts</div>
                              </div>
                              <div className="p-3 bg-green-50 rounded-lg">
                                <div className="text-2xl font-semibold text-blue-950 mb-1">8</div>
                                <div className="text-xs text-gray-600">👤 Manual Contacts</div>
                              </div>
                              <div className="p-3 bg-purple-50 rounded-lg">
                                <div className="text-2xl font-semibold text-blue-950 mb-1">15</div>
                                <div className="text-xs text-gray-600">📧 Emails Sent</div>
                              </div>
                              <div className="p-3 bg-orange-50 rounded-lg">
                                <div className="text-2xl font-semibold text-blue-950 mb-1">6</div>
                      ...
                      <div className="flex gap-3 mt-6 pt-4 border-t border-gray-300">
                        <button className="px-4 py-2 bg-gradient-to-r from-orange-500 to-pink-600 text-white rounded-lg hover:shadow-lg transition-all text-sm font-medium">
                          Save Changes
                        </button>
                        <button className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all text-sm font-medium">
                          Send Email
                        </button>
                        <button className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-all text-sm font-medium">
                          Schedule Call
                        </button>
                        <button className="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-all text-sm font-medium">
                          Export to PDF
                        </button>
                      </div>
                    </motion.div>
            ...
            <button className="mt-6 w-full px-4 py-3 border-2 border-gray-300 text-gray-700 rounded-lg hover:border-orange-400 hover:bg-orange-50 transition-all text-sm font-medium">
              Load More Contacts
            </button>
          </div>
        </div>
      ...
      <div className="mt-6 grid md:grid-cols-3 gap-6">
        <div className="bg-gradient-to-br from-blue-500 to-cyan-600 rounded-xl shadow-lg p-6 text-white">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <div className="text-3xl font-bold mb-1">664</div>
        ...
        <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl shadow-lg p-6 text-white">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <div className="text-3xl font-bold mb-1">230</div>
