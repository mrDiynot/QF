...
import {
  Shield, Database, Share2, Lock, UserCheck, Cookie,
  Clock, RefreshCw, Mail, ArrowRight, FileText,
  Eye, CheckCircle, Zap, Target,
} from 'lucide-react';
...
// ---------------------------------------------------------------------------
// Data-usage highlights (shown in the hero journey card)
// ---------------------------------------------------------------------------
const dataJourneySteps = [
  { icon: Database,  label: 'Data Collected',     sub: 'Account info, leads, conversations, payments, usage',  glow: '#3b82f6', iconGrad: 'from-blue-500 to-cyan-400' },
  { icon: Lock,      label: 'Encrypted & Stored', sub: 'SOC 2 Type II • Encryption at rest & in transit',      glow: '#10b981', iconGrad: 'from-emerald-500 to-green-400' },
  { icon: Shield,    label: 'Access Controlled',  sub: 'Role-based access, audit logging',                     glow: '#a855f7', iconGrad: 'from-violet-500 to-purple-400' },
  { icon: UserCheck, label: 'Your Rights',        sub: 'Access, correct, delete, export, opt out',             glow: '#FF5722', iconGrad: 'from-orange-500 to-red-400' },
  { icon: Eye,       label: 'Transparent Use',    sub: 'No selling data • Only essential sharing',             glow: '#6366f1', iconGrad: 'from-indigo-500 to-violet-400' },
  { icon: Clock,     label: 'Retention Policy',   sub: 'Deleted within 30 days of account closure',           glow: '#ec4899', iconGrad: 'from-pink-500 to-rose-400' },
];

const channelIcons = [Database, Lock, Shield, UserCheck, Eye, Clock, Cookie, RefreshCw];

// ---------------------------------------------------------------------------
// Your Rights items (grid section)
// ---------------------------------------------------------------------------
const rightsItems = [
  { icon: Eye,         title: 'Access Your Data',      description: 'Request a copy of all personal data we hold about you.',                     glow: '#3b82f6', borderGrad: 'linear-gradient(135deg, #3b82f6, #7c3aed)', iconGrad: 'linear-gradient(135deg, #3b82f6, #60a5fa)' },
  { icon: FileText,    title: 'Correct Inaccuracies',  description: 'Update or correct any inaccurate personal information.',                     glow: '#a855f7', borderGrad: 'linear-gradient(135deg, #7c3aed, #FF5722)',  iconGrad: 'linear-gradient(135deg, #7c3aed, #a855f7)' },
  { icon: Database,    title: 'Delete Your Data',      description: 'Request complete deletion of your personal data from our systems.',          glow: '#FF5722', borderGrad: 'linear-gradient(135deg, #FF5722, #7c3aed)',  iconGrad: 'linear-gradient(135deg, #FF5722, #FF8C42)' },
  { icon: Share2,      title: 'Export & Portability',  description: 'Export your data in a portable, machine-readable format.',                   glow: '#10b981', borderGrad: 'linear-gradient(135deg, #10b981, #7c3aed)',  iconGrad: 'linear-gradient(135deg, #10b981, #34d399)' },
  { icon: Mail,        title: 'Opt Out of Marketing',  description: 'Unsubscribe from marketing communications at any time.',                    glow: '#6366f1', borderGrad: 'linear-gradient(135deg, #6366f1, #FF5722)',  iconGrad: 'linear-gradient(135deg, #6366f1, #818cf8)' },
  { icon: Cookie,      title: 'Cookie Preferences',    description: 'Control which cookies and tracking technologies we use.',                    glow: '#ec4899', borderGrad: 'linear-gradient(135deg, #ec4899, #7c3aed)',  iconGrad: 'linear-gradient(135deg, #ec4899, #f472b6)' },
];
  ...
  return (
    <div className="min-h-screen" style={{ background: '#0d0618' }}>
      ...
      <main className="pt-20 pb-20">
        ...
        {/* ── Hero Section (two-column like About Us) ── */}
        <section
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-purple-500/30 bg-purple-500/10 backdrop-blur-sm">
                ...
                <span className="text-sm font-semibold text-purple-300">Privacy Policy</span>
              </div>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              ...
              >
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight bg-gradient-to-r from-white via-purple-200 to-orange-300 bg-clip-text text-transparent">
                  Your Privacy Is Our Priority
                </h1>
                <div className="space-y-4 text-base sm:text-lg mb-8">
                  <p className="text-white/65">
                    This policy explains how we collect, use, and protect your information when you use QualiFlow AI.
                  </p>
                  <p className="font-semibold text-white/85">
                    We believe in transparency, security, and giving you full control over your data.
                    Your trust is the foundation of everything we build.
                  </p>
                </div>
                <p className="text-sm text-white/35 mb-6">Last updated: December 9, 2025</p>
                <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4">
                  <a
                    href="mailto:privacy@qualiflow.ai"
                  ...
                  <button
                    onClick={() => document.getElementById('your-rights-section')?.scrollIntoView({ behavior: 'smooth' })}
              ...
              {/* Right Column — Data Journey Card */}
              <motion.div
                ...
                >
                  ...
                  <div className="relative z-10 p-4 sm:p-7">
                    <div className="flex items-center gap-2 mb-4 sm:mb-6">
                      ...
                      <span className="text-xs font-bold text-orange-400 uppercase tracking-widest">How We Handle Your Data</span>
                    </div>
                    ...
                    <div className="flex items-center gap-1 flex-wrap justify-center">
                      <span className="text-[10px] text-white/30 mr-1 uppercase tracking-widest">Protected</span>
        ...
        {/* ── Collection & Usage (white bg section — like Mission & Vision) ── */}
          ...
          <div className="max-w-[1200px] mx-auto relative z-10">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-purple-100 to-orange-100 mb-6">
                <span className="w-2 h-2 rounded-full bg-[#FF5722] animate-pulse" />
                <span className="text-sm font-semibold text-[#6B2D9E] tracking-wide">Data Practices</span>
              </div>
                ...
                <div className="relative rounded-2xl bg-[#0f0620] backdrop-blur-xl p-8 h-full overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full mb-6 backdrop-blur-md border border-white/20 shadow-lg shadow-purple-900/30"
                      ...
                      <span className="text-xs font-bold text-white/90 uppercase tracking-widest">What We Collect</span>
                    </div>
                    <p className="text-white/85 text-sm leading-relaxed mb-4">We collect information you provide directly, including:</p>
                    <ul className="space-y-2 text-white/70 text-sm">
                      <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-purple-400 shrink-0 mt-0.5" />Account information (name, email, company name)</li>
                      <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-purple-400 shrink-0 mt-0.5" />Lead and contact data you input into the platform</li>
                      <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-purple-400 shrink-0 mt-0.5" />Conversation and message content</li>
                      <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-purple-400 shrink-0 mt-0.5" />Payment and billing information</li>
                      <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-purple-400 shrink-0 mt-0.5" />Usage data and analytics</li>
                    </ul>
                ...
                <div className="relative rounded-2xl bg-[#0f0620] backdrop-blur-xl p-8 h-full overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full mb-6 backdrop-blur-md border border-white/20 shadow-lg shadow-orange-900/30"
                      ...
                      <span className="text-xs font-bold text-white/90 uppercase tracking-widest">How We Use It</span>
                    </div>
                    <p className="text-white/85 text-sm leading-relaxed mb-4">We use the collected information to:</p>
                    <ul className="space-y-2 text-white/70 text-sm">
                      <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-orange-400 shrink-0 mt-0.5" />Provide and maintain our services</li>
                      <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-orange-400 shrink-0 mt-0.5" />Process transactions and send related information</li>
                      <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-orange-400 shrink-0 mt-0.5" />Send you technical notices and support messages</li>
                      <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-orange-400 shrink-0 mt-0.5" />Improve and personalize the service</li>
                      <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-orange-400 shrink-0 mt-0.5" />Develop new features and functionality</li>
                    </ul>
        ...
        {/* ── Your Rights (grid like Our Team) ── */}
        <section
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-purple-500/30 bg-purple-500/10 backdrop-blur-sm mb-6">
                ...
                <span className="text-sm font-semibold text-purple-300 tracking-wide">Your Rights</span>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {rightsItems.map((item, index) => (
                ...
                >
                  ...
                  >
                    <div
                      className="absolute -top-8 -left-8 w-28 h-28 rounded-full blur-2xl opacity-30 group-hover:opacity-60 transition-opacity duration-500 pointer-events-none"
                    ...
                    <div className="relative z-10">
                      <div
                        className="w-[52px] h-[52px] rounded-xl flex items-center justify-center mb-5 shadow-lg"
                        style={{ background: item.iconGrad, boxShadow: `0 0 18px ${item.glow}55` }}
                      >
        ...
        {/* ── Security, Sharing, Cookies & Retention (like "Why Different" section) ── */}
        <section
          className="relative px-6 py-20 overflow-hidden"
            ...
            >
              <div className="flex justify-center mb-6">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-orange-500/30 bg-orange-500/10 backdrop-blur-sm">
                  ...
                  <span className="text-sm font-semibold text-orange-300 tracking-wide">Our Safeguards</span>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                >
                  <div className="relative rounded-2xl p-6 sm:p-8 h-full overflow-hidden" style={{ background: 'linear-gradient(145deg, #0f0420 0%, #1a0a2e 50%, #1a0800 100%)' }}>
                    <div className="absolute -top-8 -left-8 w-32 h-32 rounded-full bg-emerald-500/30 blur-2xl opacity-30 group-hover:opacity-60 transition-opacity duration-500 pointer-events-none" />
                    <div className="relative z-10">
                      <div className="w-[48px] h-[48px] rounded-xl bg-gradient-to-br from-emerald-500 to-green-400 flex items-center justify-center shadow-lg mb-5" style={{ boxShadow: '0 0 18px rgba(16,185,129,0.35)' }}>
                        <Lock className="w-5 h-5 text-white" />
                      </div>
                      <h4 className="text-lg font-bold text-white mb-3">Data Security</h4>
                      <p className="text-sm text-white/70 leading-relaxed">
                        We implement appropriate technical and organizational measures to protect your personal information against unauthorized access, alteration, disclosure, or destruction. Your information is stored on secure servers with encryption at rest and in transit. We are SOC 2 Type II compliant and undergo regular security audits.
                      </p>
                      <div className="mt-6 h-px bg-gradient-to-r from-emerald-500/60 via-emerald-400/30 to-transparent" />
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="relative rounded-2xl p-6 sm:p-8 h-full overflow-hidden" style={{ background: 'linear-gradient(145deg, #0f0420 0%, #1a0a2e 50%, #1a0800 100%)' }}>
                    <div className="absolute -top-8 -right-8 w-32 h-32 rounded-full bg-orange-500/30 blur-2xl opacity-30 group-hover:opacity-60 transition-opacity duration-500 pointer-events-none" />
                    <div className="relative z-10">
                      <div className="w-[48px] h-[48px] rounded-xl bg-gradient-to-br from-orange-500 to-red-400 flex items-center justify-center shadow-lg mb-5" style={{ boxShadow: '0 0 18px rgba(255,87,34,0.35)' }}>
                        <Share2 className="w-5 h-5 text-white" />
                      </div>
                      <h4 className="text-lg font-bold text-white mb-3">Information Sharing</h4>
                      <p className="text-sm text-white/70 leading-relaxed mb-3">
                        We do not sell, trade, or otherwise transfer your personal information to third parties without your consent. We may share data with:
                      </p>
                      <ul className="space-y-1.5 text-sm text-white/60">
                        <li className="flex items-start gap-2"><CheckCircle className="w-3.5 h-3.5 text-orange-400 shrink-0 mt-0.5" />Service providers who assist in operating our platform</li>
                        <li className="flex items-start gap-2"><CheckCircle className="w-3.5 h-3.5 text-orange-400 shrink-0 mt-0.5" />Third-party integrations you explicitly connect</li>
                        <li className="flex items-start gap-2"><CheckCircle className="w-3.5 h-3.5 text-orange-400 shrink-0 mt-0.5" />Law enforcement when required by law</li>
                      </ul>
                      <div className="mt-6 h-px bg-gradient-to-r from-orange-500/60 via-orange-400/30 to-transparent" />
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="relative rounded-2xl p-6 sm:p-8 h-full overflow-hidden" style={{ background: 'linear-gradient(145deg, #0f0420 0%, #1a0a2e 50%, #1a0800 100%)' }}>
                    <div className="absolute -bottom-8 -left-8 w-32 h-32 rounded-full bg-amber-500/30 blur-2xl opacity-30 group-hover:opacity-60 transition-opacity duration-500 pointer-events-none" />
                    <div className="relative z-10">
                      <div className="w-[48px] h-[48px] rounded-xl bg-gradient-to-br from-amber-500 to-yellow-400 flex items-center justify-center shadow-lg mb-5" style={{ boxShadow: '0 0 18px rgba(245,158,11,0.35)' }}>
                        <Cookie className="w-5 h-5 text-white" />
                      </div>
                      <h4 className="text-lg font-bold text-white mb-3">Cookies &amp; Tracking</h4>
                      <p className="text-sm text-white/70 leading-relaxed mb-4">
                        We use cookies and similar technologies to improve your experience, analyze usage patterns, and deliver personalized content. You can control cookie preferences at any time.
                      </p>
                      <ManageCookiesButton />
                      <div className="mt-6 h-px bg-gradient-to-r from-amber-500/60 via-amber-400/30 to-transparent" />
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="relative rounded-2xl p-6 sm:p-8 h-full overflow-hidden" style={{ background: 'linear-gradient(145deg, #0f0420 0%, #1a0a2e 50%, #1a0800 100%)' }}>
                    <div className="absolute -top-8 -right-8 w-32 h-32 rounded-full bg-violet-500/30 blur-2xl opacity-30 group-hover:opacity-60 transition-opacity duration-500 pointer-events-none" />
                    <div className="relative z-10">
                      <div className="w-[48px] h-[48px] rounded-xl bg-gradient-to-br from-violet-500 to-purple-400 flex items-center justify-center shadow-lg mb-5" style={{ boxShadow: '0 0 18px rgba(139,92,246,0.35)' }}>
                        <Clock className="w-5 h-5 text-white" />
                      </div>
                      <h4 className="text-lg font-bold text-white mb-3">Data Retention &amp; Policy Changes</h4>
                      <p className="text-sm text-white/70 leading-relaxed mb-3">
                      ...
                      <div className="mt-6 h-px bg-gradient-to-r from-violet-500/60 via-purple-400/30 to-transparent" />
                    </div>
                  </div>
                </motion.div>
              </div>
            ...
            >
              <div className="flex justify-center mb-8">
                <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full border border-purple-500/30 bg-purple-500/10 backdrop-blur-sm">
                  ...
                  <span className="text-sm font-semibold text-purple-300 tracking-wide">Privacy &amp; Trust</span>
                </div>
              </div>
              ...
              <p className="text-xl text-white/55 mb-12 max-w-xl mx-auto leading-relaxed">
                Our Data Protection Officer is here to help with any privacy-related inquiries. Reach out anytime.
              </p>
              ...
              <p className="text-sm text-white/30 mt-10">Last Updated: December 9, 2025</p>
