...
const CALL_SCENARIOS: CallScenario[] = [
  {
    title: 'Beauty Wellnes and Personal Care',
    customer: 'Ashley Chen',
    audioSrc: '/audio/beauty-wellness-and-personal-care.mp3',
  },
  //{
...
export function VoiceCallSimulator_beauty_wellness({ onBookDemo }: { onBookDemo?: () => void } = {}) {
