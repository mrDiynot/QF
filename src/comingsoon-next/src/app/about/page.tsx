...
// ---------------------------------------------------------------------------
const foundingTeam = [
  { name: 'Jurgen',     role: 'Co-Founder, Chief Growth Officer',                       borderGrad: 'linear-gradient(135deg, #FF5722, #7c3aed)', glowColor: '#FF5722', iconGrad: 'linear-gradient(135deg, #FF5722, #FF8C42)', chipLabel: 'Growth',       chipText: '#FF8C42' },
  { name: 'Edem',       role: 'Co-Founder, VP of Engineering & Cybersecurity',  borderGrad: 'linear-gradient(135deg, #7c3aed, #FF5722)', glowColor: '#7c3aed', iconGrad: 'linear-gradient(135deg, #7c3aed, #a855f7)', chipLabel: 'Co-Founder',   chipText: '#a855f7' },
  { name: 'Johannies',  role: 'Co-Founder, VP of Product Engineering',      borderGrad: 'linear-gradient(135deg, #FF5722, #7c3aed)', glowColor: '#FF5722', iconGrad: 'linear-gradient(135deg, #FF5722, #FF8C42)', chipLabel: 'Co-Founder',   chipText: '#FF8C42' },
  { name: 'Luis',       role: 'Co-Founder, Chief Revenue & Technology Officer',         borderGrad: 'linear-gradient(135deg, #7c3aed, #FF5722)', glowColor: '#7c3aed', iconGrad: 'linear-gradient(135deg, #7c3aed, #a855f7)', chipLabel: 'Revenue',      chipText: '#a855f7' },
  { name: 'Sami', role: 'Product Manager',                            borderGrad: 'linear-gradient(135deg, #FF5722, #7c3aed)', glowColor: '#FF5722', iconGrad: 'linear-gradient(135deg, #FF5722, #FF8C42)', chipLabel: 'Product',      chipText: '#FF8C42' },
];
...
export default function AboutPage() {
  return (
    <PageProvider isWhiteBackground={false}>
      <div className="min-h-screen" style={{ background: '#0d0618' }}>
        ...
        <main className="pt-16 pb-20">
          ...
          {/* ── Hero Section ── */}
          <section
            className="relative px-4 sm:px-6 py-10 md:py-16 overflow-hidden"
            ...
            <div className="max-w-7xl mx-auto relative z-10 w-full min-w-0">
              ...
              >
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-purple-500/30 bg-purple-500/10 backdrop-blur-sm">
                  ...
                  <span className="text-sm font-semibold text-purple-300">About QualiflowAI</span>
                </div>
              </motion.div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center w-full">
                ...
                >
                  <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6 leading-tight bg-gradient-to-r from-white via-purple-200 to-orange-300 bg-clip-text text-transparent w-full break-words" style={{ textWrap: 'pretty' }}>
                    We&apos;re Building the Future of Automated Customer Journeys
                  </h2>
                  <div className="space-y-3 md:space-y-4 text-base md:text-lg mb-6 md:mb-8">
                    <p className="text-white/65">
                      QualiFlow is redefining how businesses capture, qualify, book, and retain customers — automatically.
                    </p>
                  ...
                  <div className="flex flex-wrap gap-3 md:gap-4 justify-center lg:justify-start">
                    <Link
                      href="/waitlist"
                      className="inline-flex items-center gap-2 px-6 md:px-8 py-3 bg-gradient-to-r from-[#FF5722] to-[#FF8C42] text-white rounded-xl hover:shadow-lg hover:shadow-orange-500/30 transition-all font-semibold no-underline"
                    >
                      Get Early Access
                    ...
                    <button
                      ...
                      className="px-6 md:px-8 py-3 border border-white/20 text-white/80 rounded-xl hover:bg-white/10 hover:border-white/40 transition-all font-semibold backdrop-blur-sm"
                    >
                      Meet The Team
                    </button>
                  </div>
                ...
                {/* Right Column — AI Modern Journey Flow */}
                <motion.div
                    ...
                    <div className="relative z-10 p-4 md:p-7">
                      ...
                      <div className="space-y-1">
                        {journeySteps.map((step, index) => (
                          ...
                          >
                            {/* Step row */}
                            <div className="group flex items-center gap-4 px-3 py-2.5 rounded-xl hover:bg-white/5 transition-colors duration-200 cursor-default">
                              {/* Icon column with connector */}
                              <div className="flex flex-col items-center shrink-0">
                                <div
                                  className={`w-10 h-10 rounded-xl bg-gradient-to-br ${step.iconGrad} flex items-center justify-center shadow-lg`}
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="text-xs text-white/45 mt-0.5 truncate">{step.sub}</div>
                              </div>

                              {/* Step number badge */}
                              <div className="shrink-0 w-6 h-6 rounded-full border border-white/10 bg-white/5 flex items-center justify-center">
                            ...
                            {index < journeySteps.length - 1 && (
                              <div className="flex items-start gap-4 px-3 py-0.5">
          ...
          <section className="relative pt-16 pb-10 px-6 overflow-hidden bg-white">
            ...
            {/* Subtle light ambient orbs — won't overpower white bg */}
            <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-gradient-radial from-purple-100/50 to-transparent rounded-full blur-3xl pointer-events-none" />
            <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-gradient-radial from-orange-100/40 to-transparent rounded-full blur-3xl pointer-events-none" />
          ...
          >
            ...
            <div className="absolute bottom-0 right-0 w-[400px] h-[400px] rounded-full bg-[#FF5722]/08 blur-[80px] pointer-events-none" />
            ...
            <div className="max-w-7xl mx-auto relative z-10">
              ...
              >
                ...
                <p className="text-lg text-white/50 max-w-2xl mx-auto">
                  QualiFlow was built by a team combining product engineering, cybersecurity, AI infrastructure, GTM strategy, and revenue execution.
                </p>
              </motion.div>
          ...
          >
            ...
            <div className="absolute bottom-0 right-1/4 w-[450px] h-[300px] rounded-full bg-[#FF5722]/12 blur-[80px] pointer-events-none" />
            ...
            <div className="max-w-7xl mx-auto relative z-10">
              ...
              >
                ...
                <h3 className="text-4xl font-bold mb-14 text-center">
                  <span style={{ background: 'linear-gradient(135deg, #ffffff 0%, #e9d5ff 40%, #FF8C42 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', display: 'inline' }}>
                    Why QualiFlow Is Different
                  </span>
                </h3>
            ...
            <div className="max-w-[900px] mx-auto relative z-10 text-center">
              ...
              >
                ...
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                  <span style={{ background: 'linear-gradient(135deg, #ffffff 0%, #e9d5ff 45%, #a855f7 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', display: 'inline' }}>
                ...
                <p className="text-xl text-white/55 mb-12 max-w-xl mx-auto leading-relaxed">
                  QualiFlowAi is building that future — one agentic journey at a time.
                </p>
                ...
                <div className="flex gap-4 justify-center flex-wrap">
                  ...
                  <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
                    <Link
                      href="/waitlist"
                      className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-semibold text-white border border-white/20 bg-white/8 backdrop-blur-sm hover:bg-white/15 hover:border-white/35 transition-all duration-300 no-underline"
                    >
                      Join Early Access
                      <ArrowRight className="w-4 h-4" />
                    </Link>
