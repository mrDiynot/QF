              ...
              <div className="max-w-6xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                  ...
                  <div className="flex items-start gap-4 flex-1">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#6B2D9E] to-[#8B3DAE] flex items-center justify-center flex-shrink-0">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 leading-relaxed max-w-2xl">
                        ...
                        <Link href="/privacy" className="text-[#6B2D9E] hover:underline font-medium">
                          Privacy Policy
                        </Link>{' '}
                        and{' '}
                        <Link href="/terms" className="text-[#6B2D9E] hover:underline font-medium">
                          Terms of Service
                        </Link>.
                      </p>
                    </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 lg:flex-shrink-0">
                    ...
                    <button
                      ...
                      className="px-6 py-2.5 text-sm font-semibold text-white bg-gradient-to-r from-[#FF5722] to-[#FF6B35] hover:from-[#E64A19] hover:to-[#FF5722] rounded-xl transition-all shadow-lg shadow-orange-500/30 hover:shadow-xl hover:shadow-orange-500/40 order-1 sm:order-3"
                    >
                      Accept All
                    </button>
                  </div>
