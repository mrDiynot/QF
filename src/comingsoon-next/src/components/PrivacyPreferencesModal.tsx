  ...
  return (
    <div className="flex items-start gap-4 p-4 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors">
      ...
      <button
        ...
        className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-[#6B2D9E] focus:ring-offset-2 ${
          enabled ? 'bg-[#6B2D9E]' : 'bg-gray-200'
...
export function PrivacyPreferencesModal({ isOpen, onClose }: PrivacyPreferencesModalProps) {
  ...
  // Initialize from existing consent
  useEffect(() => {
    if (consent) {
      // eslint-disable-next-line react-hooks/set-state-in-effect -- sync local state from prop on open
            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-h-[90vh] overflow-hidden flex flex-col">
              ...
              <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#6B2D9E] to-[#8B3DAE] flex items-center justify-center">
              ...
              <div className="flex-1 overflow-y-auto px-6 py-4 space-y-3">
                ...
                <CategoryToggle
                  ...
                  icon={<MessageSquare className="w-5 h-5 text-[#6B2D9E]" />}
              ...
              <div className="flex flex-col sm:flex-row gap-3 px-6 py-4 border-t border-gray-200 bg-gray-50">
                ...
                <button
                  ...
                  className="flex-1 px-5 py-2.5 text-sm font-semibold text-white bg-gradient-to-r from-[#FF5722] to-[#FF6B35] hover:from-[#E64A19] hover:to-[#FF5722] rounded-xl transition-all shadow-lg shadow-orange-500/30"
                >
                  Accept All
                </button>
              </div>
