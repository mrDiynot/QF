...
export function AIDecisionEngineAnimation() {
  ...
  return (
    //    <div className="relative rounded-2xl overflow-hidden w-full max-w-3xl mx-auto lg:w-[650px]" style={{ background: 'linear-gradient(800deg, #29003a 0%, #29003a 60%, #29003a 100%)' }}>
    <div className="relative rounded-2xl w-full max-w-3xl mx-auto lg:w-[650px]">
      {/* Thin blurry white border glow */}
      <div className="absolute -inset-[2px] rounded-2xl bg-white/25 blur-[6px] pointer-events-none" />
      {/* Inner card */}
      <div className="relative rounded-2xl overflow-hidden" style={{ background: 'linear-gradient(10deg, rgba(15, 5, 30, 0.9) 0%, rgba(28, 14, 50, 0.9) 50%, rgba(18, 8, 35, 0.9) 100%)' }}>
      {/* Dot grid */}
      <div className="absolute inset-0 opacity-[0.06] pointer-events-none" style={{ backgroundImage: 'radial-gradient(circle, #ffffff 1px, transparent 1px)', backgroundSize: '22px 22px' }} />
      {/* Ambient orbs */}
      <div className="absolute -top-16 -right-16 w-48 h-48 rounded-full bg-white/5 blur-[60px] pointer-events-none" />
      <div className="absolute -bottom-12 -left-12 w-40 h-40 rounded-full bg-[#FF5722]/10 blur-[50px] pointer-events-none" />

      {/* Header bar */}
      <div className="relative z-10 border-b border-white/20 px-4 py-2.5 flex items-center justify-between shrink-0">
        {/* Window Controls */}
        <div className="flex items-center gap-2">
          <div className="w-4 h-2 rounded-full bg-[#FF0000] animate-pulse"></div>
          <div className="w-4 h-2 rounded-full bg-[#FFFF00] animate-pulse"></div>
          <div className="w-4 h-2 rounded-full bg-[#008000] animate-pulse"></div>
      ...
      <div className="relative z-10 h-[320px] sm:h-[350px] lg:h-[480px] overflow-hidden overflow-y-auto">
              ...
              {conversationStep >= 2 && (
                <div className="flex justify-end">
                  <div className="bg-gray-700 rounded-lg p-3 max-w-[75%]">
                    <p className="text-xs text-gray-400 mb-1">Qualiflow AI</p>
