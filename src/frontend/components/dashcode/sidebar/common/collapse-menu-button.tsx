                ...
                >
                    ...
                    >
                        <div className="relative">
                            ...
                            {badge && (
                                <span className="absolute -top-1 -right-1 bg-destructive text-destructive-foreground text-[9px] px-1 py-0.5 rounded-full min-w-[14px] text-center">
                                    {badge}
                                </span>
                            )}
                        </div>
    ...
    return !collapsed || hovered ? (
                        ...
                        <div className="w-full items-center flex justify-between">
                            ...
                            <div className="flex items-center">
                                ...
                                {badge && (!collapsed || hovered) && (
                                    <span className="ms-2 bg-destructive text-destructive-foreground text-xs px-1.5 py-0.5 rounded-full">
                                        {badge}
                                    </span>
                                )}
                            </div>
        ...
        <DropdownMenu >
            ...
            <DropdownMenuContent side="right" sideOffset={20} align="start" className={` border-sidebar space-y-1.5`} >
                <DropdownMenuLabel className="max-w-[190px] truncate flex items-center justify-between gap-2">
                    <span>{label}</span>
                    {badge && (
                        <span className="bg-destructive text-destructive-foreground text-xs px-1.5 py-0.5 rounded-full">
                            {badge}
                                ...
                                <DropdownMenuPortal>
                                    <DropdownMenuSubContent>
                                        <ScrollArea className='h-[200px]'>
                                            ...
                                            {children?.map(({ href, label, active: _active }, index) => (
